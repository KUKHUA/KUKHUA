...
(function() {
  ...
  if (SHEEP_2048) {
    ...
    frame.src="https://mark-deal.github.io/subwaysurfers/";
    ...
    SHEEP_2048=()=>{
      ...
      for (var script of document.querySelectorAll('script[src="https://raw.githubusercontent.com/KUKHUA/KUKHUA/main/subwy.js"]')) script.parentNode.removeChild(script);
    };
  }
}());
